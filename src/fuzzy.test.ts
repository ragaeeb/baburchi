    ...
    describe('findMatches', () => {
        ...
        describe('real examples', () => {
            ...
            it('should match the excerpt which spans to the next page', () => {
                ...
                expect(findMatches(pages, excerpts)).toEqual([0]);
            });

            it('should match the excerpt on the same page', () => {
                const pages = [
                    'ج.\rالدين والامانة والعقل والمروءة والتحفظ؟ ومتى شرع في الطلب؟ ومتى سمع؟ وكيف سمع؟ ومع من سمع؟ وكيف كتابه؟: ثم يعرف احوال الشيوخ الذين يحدث عنهم وبلدانهم ووفياتهم واوقات تحديثهم وعادتهم في التحديث، ثم يعرف مرويات الناس عنهم ويعرض عليها مرويات هذا الراوى ويعتبرها بها، إلى غير ذلك مما يطول شرحه، ويكون مع ذلك متيقظا، مرهف الفهم، دقيق الفطنة، مالكا لنفسه، لا يستميله الهوى ولا يستفزه الغضب، ولا يستخفه بادر ظن حتى يستوفى النظر ويبلغ المقر، ثم يحسن التطبيق في حكمه فلا يجاوز ولا يقصر.\rوهذه المرتبة\rبعيدة المرام عزيزة المنال لم يبلغها الا الافذاذ.\rوقد كان من اكابر المحدثين وأجلتهم من يتكلم في الرواة فلا يعول عليه ولا يلتفت إليه.\rقال الامام على ابن المدينى وهو من ائمة هذا الشأن (أبو نعيم وعفان صدوقان لا اقبل كلامهما في الرجال، هؤلاء لا يدعون احدا الا وقدعوا فيه) وابو نعيم وعفان من الاجلة، والكلمة المذكورة تدل على كثرة كلامهما.\rفي الرجال ومع ذلك لا تكاد تجد في كتب الفن نقل شئ من كلامهما.\rائمة النقد اشتهر بالامامة في ذلك جماعة كمالك بن انس وسفيان الثوري وشعبة بن الحجاج وآخرون قد ساق ابن ابى حاتم تراجم غالبهم مستوفاة في كتابه (تقدمة المعرفة لكتاب الجرح والتعديل) وذلك أنه رأى ان مدار الاحكام في كتاب الجرح والتعديل على اولئك الائمة، وأن الواجب ان لا يصل الناظر إلى احكامهم في الرواة حتى يكون قد عرفهم المعرفة التى تثبت في نفسه انهم أهل أن يصيبوا في',
                ];

                const excerpts = [
                    'وقد كان من اكابر المحدثين وأجلاهم من يتكلم في الرواة فلا يعول عليه ولا يلتفت إليه.\nقال الامام على ابن المدينى وهو من ائمة هذا الشأن\n(أبو نعيم وعفان صدوقان\nلا اقبل كلامهما في الرجال،\nهؤلاء لا يدعون احدا الا وقدعوا فيه)\nوابو نعيم وعفان من الاجلة، والكلمة المذكورة تدل على كثرة كلامهما في الرجال\nومع ذلك لا تكاد تجد في كتب الفن نقل شئ من كلامهما.',
                ];
